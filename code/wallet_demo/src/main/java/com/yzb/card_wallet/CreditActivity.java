...
import com.yzb.R;
import com.yzb.wallet.openInterface.PayCreditHandle;
...
public class CreditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_old_credit);
        ...
        ((Button) findViewById(R.id.ordinaryBtn)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PayCreditHandle payHandle = new PayCreditHandle(CreditActivity.this);
                payHandle.pay(params);
                payHandle.setCallBack(new WalletBackListener() {
                    @Override
                    public void setSuccess(String RESULT_CODE) {
                        System.out.println("======银行还款=======>" + RESULT_CODE);
                        WalletToastCustom.sendDialog(CreditActivity.this, getWindow().peekDecorView(), "支付成功", 140);
                    }
                    ...
                    public void setError(String RESULT_CODE, String ERROR_MSG) {
                        System.out.println("======银行还款=======>" + RESULT_CODE);
                        WalletToastCustom.sendDialog(CreditActivity.this, getWindow().peekDecorView(), ERROR_MSG, 140);
                    }
                });
            }
        });
        ...
        ((LinearLayout) findViewById(R.id.chosePayMethod)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                params.put("UUID", "1");
                PayMethod payHandle = new PayMethod(CreditActivity.this);
