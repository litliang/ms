...
public class OrdinaryNoMethodActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_old_ordinary_no_method);
        ...
        ((Button) findViewById(R.id.noMethodBtn)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                PayOrdinaryHandle payHandle = new PayOrdinaryHandle(OrdinaryNoMethodActivity.this);
                payHandle.pay(params);
                payHandle.setCallBack(new WalletBackListener() {
                    @Override
                    public void setSuccess(String RESULT_CODE) {
                        System.out.println("======普通支付(无支付方式)=======>" + RESULT_CODE);
                        WalletToastCustom.sendDialog(OrdinaryNoMethodActivity.this, getWindow().peekDecorView(), "支付成功", 140);
                    }
                    ...
                    public void setError(String RESULT_CODE, String ERROR_MSG) {
                        System.out.println("======普通支付(无支付方式)=======>" + RESULT_CODE);
                        WalletToastCustom.sendDialog(OrdinaryNoMethodActivity.this, getWindow().peekDecorView(), ERROR_MSG, 140);
                    }
                });
            }
        });
