package com.jamgle.pickerviewlib.lib;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.wheelview_wvtextColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.wheelview_wvtextColorCenter,textColorCenter);
            dividerColor = a.getColor(R.styleable.wheelview_wvdividerColor,dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.wheelview_wvtextSize,textSize);
        }
