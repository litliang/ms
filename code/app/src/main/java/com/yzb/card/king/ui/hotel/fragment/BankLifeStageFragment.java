    ...
    private void initData()
    {
     ...
     Bundle bundle =   getArguments();
        ...
        if(bundle.containsKey("goldTicketParam")){
            ...
            List<LifeStageDetailBean> lifeStageDetailBeanList = new ArrayList<LifeStageDetailBean>();

            LifeStageDetailBean oneBean = new LifeStageDetailBean();

            oneBean.setBankId(1);

            oneBean.setBankName("交通银行");

            List<LifeStageDetailBean.StageBean> stageListOne = new ArrayList<LifeStageDetailBean.StageBean>();

            LifeStageDetailBean.StageBean stageListOneToOne = new LifeStageDetailBean.StageBean();

            stageListOneToOne.setActId(1);

            stageListOneToOne.setRate(0.2f);

            stageListOneToOne.setStage("3期");

            stageListOneToOne.setServiceFee(0.05f);

            stageListOne.add(stageListOneToOne);

            LifeStageDetailBean.StageBean stageListOneToTwo = new LifeStageDetailBean.StageBean();

            stageListOneToTwo.setActId(2);

            stageListOneToTwo.setRate(0.3f);

            stageListOneToTwo.setStage("6期");

            stageListOneToTwo.setServiceFee(0.06f);

            stageListOne.add(stageListOneToTwo);

            LifeStageDetailBean.StageBean stageListOneToThree = new LifeStageDetailBean.StageBean();

            stageListOneToThree.setActId(3);

            stageListOneToThree.setRate(0.4f);

            stageListOneToThree.setStage("9期");

            stageListOneToThree.setServiceFee(0.07f);

            stageListOne.add(stageListOneToThree);

            oneBean.setStageList(stageListOne);

            lifeStageDetailBeanList.add(oneBean);
          /////////////////////////////////////////////////////////

            LifeStageDetailBean twoBean = new LifeStageDetailBean();

            twoBean.setBankId(2);

            twoBean.setBankName("建设银行");

            List<LifeStageDetailBean.StageBean> stageListTwo = new ArrayList<LifeStageDetailBean.StageBean>();

            LifeStageDetailBean.StageBean stageListTwoToOne = new LifeStageDetailBean.StageBean();

            stageListTwoToOne.setActId(1);

            stageListTwoToOne.setRate(0.2f);

            stageListTwoToOne.setStage("3期");

            stageListTwoToOne.setServiceFee(0.05f);

            stageListTwo.add(stageListTwoToOne);

            LifeStageDetailBean.StageBean stageListTwoToTwo = new LifeStageDetailBean.StageBean();

            stageListTwoToTwo.setActId(2);

            stageListTwoToTwo.setRate(0.3f);

            stageListTwoToTwo.setStage("6期");

            stageListTwoToTwo.setServiceFee(0.06f);

            stageListTwo.add(stageListTwoToTwo);


            twoBean.setStageList(stageListTwo);


            lifeStageDetailBeanList.add(twoBean);
