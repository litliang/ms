 ...
 * 描  述：
 */
public class TimeSelectDialog extends BaseDialogPeopleChoseFragment implements View.OnClickListener {
    ...
    private void initData()
    {
        ...
        {
            @Override
            public void onChanged(com.example.dev.mylibrary.WheelView wheelView, int oldValue, int currentValue)
            {
