...
import com.yzb.card.king.ui.my.adapter.StoreJsDetailAdapter2;
 ...
 * 描 述：商店积分明细查询
 */
public class StoreJfDetailActivity2 extends BaseActivity implements BaseViewLayerInterface, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private StoreJsDetailAdapter2 adapter;
    ...
    private void initData() {
        ...
        if (listBean != null && listBean.size() != 0) {
            adapter = new StoreJsDetailAdapter2(this, listBean);
    ...
    private void initDataChangeAdapter() {
        if (adapter != null) {
            adapter.setOnClickListenerBillingDetail(new StoreJsDetailAdapter2.OnClickListenerBillingDetail() {
                @Override
                public void onLoad() {
                    if ( size > 19 ) {//条件后面变化
