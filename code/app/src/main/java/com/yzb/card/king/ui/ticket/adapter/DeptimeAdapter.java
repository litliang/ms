 ...
 * 描述：
 */
public class DeptimeAdapter extends RecyclerView.Adapter
{
    ...
    public DeptimeAdapter(List<FilterType> mDatas, Context context)
    {
        this.mDatas = mDatas;
        ...
        if (holder instanceof FilterBaseHolder)
        {
            ...
            vh.checkBox.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        onClickListener.onClick(position, FilterTypes.DEPTIME);
                    }
