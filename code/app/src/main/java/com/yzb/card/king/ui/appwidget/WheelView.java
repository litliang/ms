...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(getResources().getColor(R.color.wordBlack));
            } else {
                itemView.setTextColor(getResources().getColor(R.color.wordGrey));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                canvas.drawLine(0, obtainSelectedAreaBorder()[0], viewWidth * 10, obtainSelectedAreaBorder()[0], paint);
                canvas.drawLine(0, obtainSelectedAreaBorder()[1], viewWidth * 10, obtainSelectedAreaBorder()[1], paint);
            }
