 ...
 * 描  述：
 */
public class HotelFiltratePopup implements View.OnClickListener {
     ...
     */
    public HotelFiltratePopup(Activity activity, int defineHeight)
    {
        ...
        for (int i = 0; i < strArray.length; i++) {
            ...
            if (i == 0) {
                ...
                String[] validityNameArray = activity.getResources().getStringArray(R.array.hotel_validity_name_array);

                int[] validityValueIntArray = activity.getResources().getIntArray(R.array.hotel_validity_value_array);

                int length = validityNameArray.length;
                ...
                for (int j = 0; j < length; j++) {
                    ...
                    brandBean.setFilterName(validityNameArray[j]);

                    brandBean.setFilterId(validityValueIntArray[j]+"");
