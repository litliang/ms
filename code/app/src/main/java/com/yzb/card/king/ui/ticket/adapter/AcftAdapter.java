 ...
 * 描述：
 */
public class AcftAdapter extends RecyclerView.Adapter
{
    ...
    public AcftAdapter(List<FilterType> datas, Context context)
    {
        this.mDatas = datas;
        ...
        if (holder instanceof FilterBaseHolder)
        {
            ...
            vh.checkBox.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        onClickListener.onClick(position, FilterTypes.ACFT);
                    }
