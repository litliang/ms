...
import com.yzb.card.king.ui.hotel.activtiy.FlashSaleProductOrderActivity;
 ...
 * 描  述：
 */
public class FlashSaleProductDetailDialog extends DialogFragment implements View.OnClickListener{

    private FlashSaleInfoBean item;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        item = (FlashSaleInfoBean) bundle.get("dataDetail");
        ...
        switch (v.getId()) {
            ...
            case R.id.tvConfirm:
                ...
                if (UserManager.getInstance().isLogin()) {
                    ...
                    Intent intent = new Intent(getActivity(), FlashSaleProductOrderActivity.class);
