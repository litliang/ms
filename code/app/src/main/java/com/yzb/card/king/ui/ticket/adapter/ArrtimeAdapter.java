 ...
 * 描述：
 */
public class ArrtimeAdapter extends RecyclerView.Adapter
{
    ...
    public ArrtimeAdapter(List<FilterType> mDatas, Context context)
    {
        this.mDatas = mDatas;
        ...
        if (holder instanceof FilterBaseHolder)
        {
            ...
            vh.checkBox.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        onClickListener.onClick(position, FilterTypes.ARRTIME);
                    }
