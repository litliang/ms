 ...
 * @date: 2016/9/22
 */
public class ReplylistModelImpl implements BaseModel
{
    private BaseMultiLoadListener loadListener;

    public ReplylistModelImpl(BaseMultiLoadListener loadListener)
    {
    ...
    public void loadData(final boolean event_tag, Map<String, Object> paramMap)
    {
        ...
        new SimpleRequest(serviceName, paramMap, new BaseRequest.Listener()
        {
            ...
            {
                List<PjReplyBean> pjBeans = JSON.parseArray(data, PjReplyBean.class);
