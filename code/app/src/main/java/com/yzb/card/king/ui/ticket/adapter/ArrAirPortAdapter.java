...
/**
 * 类名： ArrAirPortAdapter
 * 作者： Lei Chao.
 * 日期： 2016-10-15
 * 描述：
 */
public class ArrAirPortAdapter extends RecyclerView.Adapter
{
    ...
    public ArrAirPortAdapter(List<FilterType> mDatas, Context context)
    {
        this.mDatas = mDatas;
        ...
        if (holder instanceof FilterBaseHolder)
        {
            ...
            vh.checkBox.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        onClickListener.onClick(position, FilterTypes.ARRAIRPORT);
                    }
