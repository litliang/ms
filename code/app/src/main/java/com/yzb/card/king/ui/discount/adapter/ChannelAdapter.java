...
import com.yzb.card.king.ui.luxury.activity.OnDragVHListener;
import com.yzb.card.king.ui.luxury.activity.OnItemMoveListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener
{
    ...
    private List<ChildTypeBean> mMyChannelItems, mOtherChannelItems;
     ...
     * @return
     */
    public List<ChildTypeBean> getMyChannelList()
    {
    ...
    public ChannelAdapter(Context context, ItemTouchHelper helper, List<ChildTypeBean> mMyChannelItems, List<ChildTypeBean> mOtherChannelItems)
    {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType)
    {
        ...
        switch (viewType)
        {
            ...
            case TYPE_MY:
                ...
                myHolder.root.setOnLongClickListener(new View.OnLongClickListener()
                {
                    @Override
...
//                                tvBtnEdit.setText(R.string.finish);
                ...
                myHolder.root.setOnTouchListener(new View.OnTouchListener()
                {
                    @Override
            ...
            case TYPE_OTHER:
                ...
                otherHolder.root.setOnClickListener(new View.OnClickListener()
                {
                    @Override
                            ...
                            } else
                            {
                                ...
                                if (gridLayoutManager.findLastVisibleItemPosition() == getItemCount() - 1)
                                {
                                    ...
                                    if ((getItemCount() - 1 - mMyChannelItems.size() - COUNT_PRE_OTHER_HEADER) % spanCount == 0)
                                    {
                                        ...
                                        { // 在这种情况下 并且 RecyclerView高度变化时(即可见第一个item的 position != 0),
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position)
    {
        if (holder instanceof MyViewHolder)
        {
            ...
            ChildTypeBean childTypeBean = mMyChannelItems.get(position - COUNT_PRE_MY_HEADER);
            myHolder.textView.setText(childTypeBean.typeName);

            CommonUtil.downloadImageForView(childTypeBean.typeImage, myHolder.iv_bg, 30);
        ...
        } else if (holder instanceof OtherViewHolder)
        {
            ...
            ChildTypeBean childTypeBean = mOtherChannelItems.get(position - mMyChannelItems.size() - COUNT_PRE_OTHER_HEADER);
            otherViewHolder.textView.setText(childTypeBean.typeName);
            x.image().bind(otherViewHolder.iv_bg, childTypeBean.typeImage, GlobalApp.getInstance().getImageOptionsLogo());
...
//            }
    ...
    private void moveMyToOther(MyViewHolder myHolder)
    {
        ...
        ChildTypeBean item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder)
    {
        ...
        ChildTypeBean item = mOtherChannelItems.get(startPosition);
    ...
    {
        ChildTypeBean item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements OnDragVHListener
    {
        ...
        {
//            textView.setBackgroundResource(R.drawable.channel_bg_pressed);
        }
        ...
        {
//            textView.setBackgroundResource(R.drawable.channel_bg_selector);
        }
    }
