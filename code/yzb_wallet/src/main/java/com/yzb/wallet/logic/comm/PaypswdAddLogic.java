 ...
 * 支付密码设置
 */
public class PaypswdAddLogic extends BasePay {

    private Activity activity;

    Map<String, String> params;

    public PaypswdAddLogic(Activity activity) {
    ...
    public void setPayPwd() {
        ...
        new AsyncTask<String, Void, Map<String, String>>() {
            protected Map<String, String> doInBackground(String... params) {
                return ServiceDispatcher.callApp(activity, ServiceDispatcher.setParams(CardConstant.app_add_pay_pswd, params[0]));
            }
