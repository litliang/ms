package com.yzb.wallet.gridpasswordview;
...
import com.yzb.wallet.gridpasswordview.imebugfixer.ImeDelBugFixedEditText;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textColor == null)
            textColor = ColorStateList.valueOf(getResources().getColor(R.color.grey18));
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.gridpassword_view, this);
        ...
        while (index < passwordLength) {
            View dividerView = inflater.inflate(R.layout.gridpassword_divider, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.gridpassword_textview, null);
